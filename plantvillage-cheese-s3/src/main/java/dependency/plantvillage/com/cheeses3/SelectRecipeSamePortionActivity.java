...
public class SelectRecipeSamePortionActivity extends AppCompatActivity {
  ...
  ArrayList<String> recipeFoodsList44 = new ArrayList<String>();
  ArrayList<String> recipeFoodsList45 = new ArrayList<String>();
  ArrayList<String> recipeFoodsList46 = new ArrayList<String>();
  ArrayList<String> recipeFoodsList47 = new ArrayList<String>();
  ArrayList<String> recipeFoodsList48 = new ArrayList<String>();
  ArrayList<String> recipeFoodsList49 = new ArrayList<String>();
  ArrayList<String> recipeFoodsList50 = new ArrayList<String>();
  ArrayList<String> recipeFoodsList51 = new ArrayList<String>();
  ArrayList<String> recipeFoodsList52 = new ArrayList<String>();
  ArrayList<String> recipeFoodsList53 = new ArrayList<String>();
  ArrayList<String> recipeFoodsList54 = new ArrayList<String>();
  ArrayList<String> recipeFoodsList55 = new ArrayList<String>();
  ArrayList<String> recipeFoodsList56 = new ArrayList<String>();
  ArrayList<String> recipeFoodsList57 = new ArrayList<String>();
  ArrayList<String> recipeFoodsList58 = new ArrayList<String>();
  ArrayList<String> recipeFoodsList59 = new ArrayList<String>();
  ArrayList<String> recipeFoodsList60 = new ArrayList<String>();
  ArrayList<String> recipeFoodsList61 = new ArrayList<String>();
  ArrayList<String> recipeFoodsList62 = new ArrayList<String>();
  ArrayList<String> recipeFoodsList63 = new ArrayList<>();
  ArrayList<String> recipeFoodsList64 = new ArrayList<>();
  ArrayList<String> recipeFoodsList65 = new ArrayList<>();
  ArrayList<String> recipeFoodsList66 = new ArrayList<>();
  ArrayList<String> recipeFoodsList67 = new ArrayList<>();
  ArrayList<String> recipeFoodsList68 = new ArrayList<String>();
  ArrayList<String> recipeFoodsList69 = new ArrayList<String>();
  ArrayList<String> recipeFoodsList70 = new ArrayList<String>();
  ...
  ArrayList<Integer> recipeFoodIDsList44 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList45 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList46 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList47 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList48 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList49 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList50 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList51 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList52 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList53 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList54 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList55 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList56 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList57 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList58 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList59 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList60 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList61 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList62 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList63 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList64 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList65 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList66 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList67 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList68 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList69 = new ArrayList<Integer>();
  ArrayList<Integer> recipeFoodIDsList70 = new ArrayList<Integer>();
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    //}
    //Toast.makeText(SelectRecipeSamePortionActivity.this,  "dishtype = " + dishType, Toast.LENGTH_SHORT).show();
    ...
    expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
      ...
      public boolean onChildClick(ExpandableListView parent, View v,
        ...
        recipeName = expandableListDetail.get(
                ...
                childPosition);
        //food_id = 1;
        Toast.makeText(SelectRecipeSamePortionActivity.this,  recipeName + " Selected", Toast.LENGTH_SHORT).show();
        ...
        Collections.sort(recipeCodeList);

        /*System.out.println("UNSORTED recipe list");
        for (int i = 0; i<recipeCodeList.size();i++){
          System.out.println(recipeCodeList.get(i));
        }
        System.out.println("SORTED recipe list");
        for (int i = 0; i<recipeCodeList.size();i++){
          recipeCodeList.get(i);
        }*/
        filename = "";
        for (int i = 0; i < recipeCodeList.size();i++) {
          //recipe_idx = recipe_list.indexOf(recipeName);
       ...
       // System.out.println("\n\n\n\nouter index = " + outerIndex);
        ...
        for (int j = 0; j < vietnam_foods_list_of_lists.get(outerIndex).size(); j++) {
          ...
          //System.out.println("adding food = " + vietnam_foods_list_of_lists.get(outerIndex).get(j));
        ...
        for (int j = 0; j < foods_to_add.size(); j++) {
          //Toast.makeText(SelectRecipeSamePortionActivity.this, , Toast.LENGTH_SHORT).show();
          food_id_list.add(foods_to_add.get(j));
         // System.out.println("adding food id = " + foods_to_add.get(j));

        }

        portion_list.clear();
        for (int i = 0;i<food_list.size();i++) {
          portion_list.add(portionSize);
          portion_id_list.add(portionID);
        }
        ...
        if (picType == 1 ) { // individual meal
          ...
          selectAddFoodCapture(v, recipeName, 2); // individual meal
        } else {
          selectAddFoodCapture(v, recipeName, 0); // family meal
        }
        return false;
      }
    });
  ...
  public void selectAddFoodCapture(View view, String recipeName, int picType) {
